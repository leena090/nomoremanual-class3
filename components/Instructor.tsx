      ...
      <div className="mx-auto max-w-[720px] px-6">
        ...
        <ScrollReveal>
          ...
          <div className="mt-6 flex gap-7 rounded-2xl bg-[#F5E6D3] p-8 max-[600px]:flex-col max-[600px]:items-center max-[600px]:text-center">
            {/* 아바타 — 원형 배경에 Phosphor 아이콘 */}
            <div className="flex h-20 w-20 shrink-0 items-center justify-center rounded-full bg-[#E8D5C0]">
              <GraduationCap size={32} weight="duotone" className="text-[#D4542B]" />
            </div>

...
const faqData: FAQItem[] = [
  {
    ...
    answer:
      "네, 강사 본인도 코딩을 모릅니다. 1·2기 수강생 대부분이 50~70대였고 전원 완주했어요. 한국어로 지시만 하면 되기 때문에 코딩 지식은 0%여도 됩니다.",
  },
  {
  ...
  {
    question: "수업에 참석 못 하면 어떻게 되나요?",
    answer:
      "미출석 시 해당 회차 녹화 영상으로 수업을 대체합니다. 신청 시 영상 대체에 동의해주셔야 합니다. 녹화본은 수강 기간 중 무제한 시청 가능합니다.",
  },
  {
    question: "이전 기수랑 뭐가 달라요?",
    answer:
      "1·2기 피드백을 100% 반영했습니다. 코워크 실무 자동화 실습 강화, 웹인클로드 리서치 체험 추가, 유형별 맞춤 트랙 세분화, 사전 세팅 가이드 배포로 수업 시간을 더 알차게 구성했습니다.",
  },
];
